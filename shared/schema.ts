...
export const workouts = pgTable("workouts", {
  ...
  targetMuscleGroups: text("target_muscle_groups").array(), // array of muscle groups
  tags: text("tags").array(), // array of tags
  exercises: json("exercises"), // JSON array of exercise objects
  autoGenerated: boolean("auto_generated").default(false),
  createdBy: text("created_by"), // 'ai-agent' or 'user'
